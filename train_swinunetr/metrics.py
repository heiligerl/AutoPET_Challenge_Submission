# copied from: https://github.com/lab-midas/autoPET/blob/master/val_script.py
...
def compute_metrics2(gt_array, pred_array, mask_is_empty, voxel_vol=(2.03642 * 2.03642 * 3.0) / 1_000):
